...
def version_locations() -> dict[str, str]:
    ...
    backend_path = ROOT / 'questmath/app/backend/app/v0351.py'
    return {
        ...
        'backend/app/v0351.py app.version': _match(backend_path, r"app\.version\s*=\s*['\"]([^'\"]+)"),
        'backend/app/v0351.py health version': _match(backend_path, r"legacy\.APP_VERSION\s*=\s*['\"]([^'\"]+)"),
