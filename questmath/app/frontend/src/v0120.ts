...
function updateVersion(){document.querySelectorAll('.version').forEach(n=>{if(n.textContent!=='Version 0.12.1')n.textContent='Version 0.12.1'});document.querySelectorAll('.header-version').forEach(n=>{if(n.textContent!=='v0.12.1')n.textContent='v0.12.1'})}
