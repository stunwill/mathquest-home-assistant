...
- Preserve worksheets, targeted learning, adaptive progression, diagnostics, Math Mentor and stored learner evidence unchanged.
...
- Story Adventure, Progress, Parent Tests, worksheet history/resume and Home Assistant ingress remain on the existing learning/evidence path.
- Physical iPhone/iPad acceptance remains pending until tested on real devices.
